...
class Optimizer_SGD:
    ...
    Default learning rate is 1.0, decay is 0.1, momentum is 0
    '''
...
class Optimizer_AdaGrad:
    ...
    Default learning rate is 1.0, decay is 0.1, epsilon is 1e-7
    '''
...
class Optimizer_RMSprop:
    '''Root Mean Squared Propogation Optimizer\n
    __init__(learning_rate, decay, epsilon, rho)\n
    Default learning rate is 0.001, decay is 0.1, epsilon is 1e-7, rho is 0.9
    '''
...
class Optimizer_Adam:
    ...
    __init__(learning_rate, decay, epsilon, beta_1, beta_2)\n
    Default learning rate is 0.001, decay is 0.1, epsilon is 1e-7, beta_1 is 0.9, beta_2 is 0.999
    '''
